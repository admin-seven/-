...
<body>
	...
	<table id="tabStu" class="easyui-datagrid">
	  ...
	  -->
				...
				<th
					data-options="field:'status',title:'学历',formatter:formatterstatus"></th>
	...
	<div id="tabBar">
		...
		<a href="javascript:void(0)" class="easyui-linkbutton"
			onclick="lookstu()" data-options="iconCls:'icon-cut'">隐藏指定列</a> <a
	...
	<div id="zhuizong-dialog" class="easyui-dialog"
		style="width: 600px; height: 300px"
		data-options="title:'追踪学员窗口',modal:true,closed:true,
					buttons:[{
						text:'保存',
						handler:function(){zhuizongStu()}
					},{
						text:'关闭',
						handler:function(){zzStu()}
					}]">
		<form id="zhuizong-frm">
			<table>
				<thead>
					<tr>
						<td></td>
			...
			<table>
				<thead>
					...
					<tr>
						...
						<td><input class="easyui-validatebox" readonly="readonly"
							type="text" name="inClassContent" /></td>
					</tr>
					<tr>
			...
			<table>
				<thead>
					<tr>
						...
						<td><input class="easyui-validatebox" readonly="readonly"
							type="text" name="id" id="updateid" /></td>
					</tr>
					<tr>
						<td><label for="name">姓名:</label></td>
					...
					<tr>
						<td><label for="name">性别:</label></td>
						<td><select id="updatesex" name="sex" class="easyui-combobox">
								<option value="">---请选择---</option>
								<option value="1">男</option>
								<option value="2">女</option>
						</select></td>
					...
					<tr>
						<td><label for="name">学历:</label></td>
						<td><select id="updatestatus" name="status"
					...
					<tr>
						<td><label for="name">状态:</label></td>
						<td><select id="updatestate" name="state"
							class="easyui-combobox">
								<option value="">---请选择---</option>
								<option value="1">有状态</option>
								<option value="2">无状态</option>
					...
					<tr>
						<td><label for="name">是否报备:</label></td>
						<td><select id="updateisBaoBei" name="isValid"
							class="easyui-combobox">
								<option value="">---请选择---</option>
								<option value="1">已报备</option>
								<option value="2">未报备</option>
